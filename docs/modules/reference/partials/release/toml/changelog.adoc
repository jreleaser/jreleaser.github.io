  ...
  # Filter log entry by matching paths.
  # Use this option if working with a monorepo and only
  # a handful of subprojects should be processed.
  # icon:dot-circle[]
  changelog.paths = ["my-subproject"]
