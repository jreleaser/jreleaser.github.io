...
If there is more than one matching artifact in a given distribution you may add a `skipWinget` extra property to the target
artifact to mark it as skipped for packaging with winget.
