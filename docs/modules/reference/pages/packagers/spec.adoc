...
:packager_sys_key: spec
:packager_env_key: SPEC
:tap_sys_key:      repository
:tap_env_key:      REPOSITORY
:tap_basename_sys: spec
:tap_basename_env: SPEC
...
License:   Apache-2.0
URL:       pass:[https://acme.com/app]
Source0:   pass:[https://github.com/duke/app/releases/download/v1.2.3/app-1.2.3.tar.gz]
