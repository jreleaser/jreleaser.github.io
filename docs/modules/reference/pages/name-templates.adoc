...
The following names are related to xref:reference:announce/zernio.adoc[].

Every key/value from `zernio.extraProperties` is mapped with `zernio` as key prefix and the capitalized
key, such that
