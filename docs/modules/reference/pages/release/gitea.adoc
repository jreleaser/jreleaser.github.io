= Gitea
:gitservice_id:       gitea
:gitservice_name:     Gitea
:gitservice_env_name: GITEA
:gitservice_host:     my.gitea.com
:gitservice_api:      pass:[https://my.gitea.com]
:gitservice_blob:     src
:repo-owner:          duke
:repo-name:           app
:issue-tracker-url:   https://my.gitea.com/{repo-owner}/{repo-name}/issues
...
| draft              | jreleaser.draft            | JRELEASER_DRAFT
| prerelease.pattern | jreleaser.prelease.pattern | JRELEASER_PRERELEASE_PATTERN
|===
