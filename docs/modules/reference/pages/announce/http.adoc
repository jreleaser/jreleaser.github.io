...
| username
| jreleaser.announce.{announcer_sys_key}.${name}.username +
  jreleaser.{announcer_sys_key}.${name}.username
| JRELEASER_ANNOUNCE_{announcer_env_key}_${name}_USERNAME +
  JRELEASER_{announcer_env_key}_${name}_USERNAME
| password
| jreleaser.announce.{announcer_sys_key}.${name}.password +
  jreleaser.{announcer_sys_key}.${name}.password
| JRELEASER_ANNOUNCE_{announcer_env_key}_${name}_PASSWORD +
  JRELEASER_{announcer_env_key}_${name}_PASSWORD
|===
