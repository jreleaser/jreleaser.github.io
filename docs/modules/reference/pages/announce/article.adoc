...
| jreleaser.announce.{announcer_sys_key}.{tap_sys_key}.active
| JRELEASER_ANNOUNCE_{announcer_env_key}_{tap_env_key}_ACTIVE
2+| *{tap_sys_key}.username*
| jreleaser.announce.{announcer_sys_key}.{tap_sys_key}.username +
...
| JRELEASER_ANNOUNCE_{announcer_env_key}_{tap_env_key}_USERNAME +
...
2+| *{tap_sys_key}.token*
| jreleaser.announce.{announcer_sys_key}.{tap_sys_key}.token +
...
| JRELEASER_ANNOUNCE_{announcer_env_key}_{tap_env_key}_TOKEN +
...
| jreleaser.announce.{announcer_sys_key}.{tap_sys_key}.branch +
...
| JRELEASER_ANNOUNCE_{announcer_env_key}_{tap_env_key}_BRANCH +
...
| jreleaser.announce.{announcer_sys_key}.{tap_sys_key}.branch.push +
...
| JRELEASER_ANNOUNCE_{announcer_env_key}_{tap_env_key}_BRANCH_PUSH +
