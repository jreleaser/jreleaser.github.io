...
link:https://github.com/jreleaser/release-action/blob/java/README.adoc#slsa-builder[SLSA builders].

WARNING: This feature does not generate provenance on its own, you must combine it with a SLSA builder.
