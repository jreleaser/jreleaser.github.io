...
----
curl https://github.com/jreleaser/jreleaser-appimage/releases/download/v{jreleaser-version}/jreleaser-{jreleaser-version}-x86_64.AppImage --output jreleaser
chmod +x jreleaser
----
...
Where image may be `jreleaser-slim`, `jreleaser-alpine`, `jreleaser-ubi`.
...
You can find tag listings for link:https://hub.docker.com/r/jreleaser/jreleaser-slim/tags[jreleaser-slim],
link:https://hub.docker.com/r/jreleaser/jreleaser-alpine/tags[jreleaser-alpine],
link:https://hub.docker.com/r/jreleaser/jreleaser-ubi/tags[jreleaser-ubi].
