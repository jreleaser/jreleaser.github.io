...
of its source language, although it provides additional benefits to Java based projects.

== What it does

JReleaser takes inputs from popular builds tools (Apache Ant, Apache Maven, Gradle, Cargo) such as JAR files, binary distributions
