...
| xref:ROOT:distributions/binary.adoc[]         | {icon_req_y}
| xref:ROOT:distributions/java-binary.adoc[]    | {icon_req_y}
| xref:ROOT:distributions/jlink.adoc[]          | {icon_req_y}
| xref:ROOT:distributions/native-image.adoc[]   | {icon_req_y}
| xref:ROOT:distributions/native-package.adoc[] | {icon_req_y}
| xref:ROOT:distributions/single-jar.adoc[]     | {icon_req_n}
|===
