...
NOTE: Only artifacts with `.tgz`, `.tar.gz`, or `.tar` extension may be packaged with Spec.
...
be one of [`JRELEASER_SPEC_GITHUB_TOKEN`, `JRELEASER_SPEC_GITLAB_TOKEN`, `JRELEASER_SPEC_GITEA_TOKEN`].
