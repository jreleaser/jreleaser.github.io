...
responsibility to update the official link:https://github.com/macports/macports-ports/[] with a PR of your own. As
a reference JReleaser publishes its release using a link:https://github.com/jreleaser/jreleaser-macports/blob/main/.github/workflows/update.yml[GitHub workflow]
