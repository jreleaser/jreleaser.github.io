...
IMPORTANT: This announcer is configured per distribution. If you need a single candidate for the whole project spanning
multiple distributions then consider using the xref:configuration:announce/sdkman.adoc[] announcer instead.
