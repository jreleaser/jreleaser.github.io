...
Linux and Windows. This packager generates a fish food file band publishes it to a repository of your choice, however
it' just responsibility to update the official link:https://github.com/fishworks/fish-food[] with a PR of your own.
...
If there is more than on matching artifact in a given distribution you may add a `skipGofish` extra property to the target
