...
| projectVersionNumber     | the version number (no build, no tag) of the project's version (semver, java_module)
| projectVersionPrerelease | the prerelease (if any) of the project's version (java_module)
