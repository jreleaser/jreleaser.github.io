...
:deployer_name: Gitea
:prefix:        GITEA
:deployer_url:  https://codeberg.org/api/packages/{{owner}}/maven
:default_auth:  BEARER
...
If you need to upload any other binaries then check the xref:configuration:upload/gitea.adoc[{deployer_name} Uploader].
