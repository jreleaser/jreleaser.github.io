...
include::partial$release/yaml/milestone.adoc[]
    ...
    # icon:dot-circle[] icon:file-alt[]
    downloadUrl: https://{{repoHost}}/{{repoOwner}}/{{repoName}}/-/releases/{{tagName}}/downloads/{{artifactFileName}}]

    # icon:dot-circle[] icon:file-alt[]
    releaseNotesUrl: https://{{repoHost}}/{{repoOwner}}/{{repoName}}/-/releases/{{tagName}}]

    # icon:dot-circle[] icon:file-alt[]
    latestReleaseUrl: https://{{repoHost}}/{{repoOwner}}/{{repoName}}/-/releases/{{tagName}}]
...
include::partial$release/maven/milestone.adoc[]
      ...
      <!--
        icon:dot-circle[] icon:file-alt[]
      -->
      <downloadUrl>https://{{repoHost}}/{{repoOwner}}/{{repoName}}/-/releases/{{tagName}}/downloads/{{artifactFileName}}</downloadUrl>
      ...
      <!--
        icon:dot-circle[] icon:file-alt[]
      -->
      <latestReleaseUrl>https://{{repoHost}}/{{repoOwner}}/{{repoName}}/-/releases/{{tagName}}</latestReleaseUrl>
