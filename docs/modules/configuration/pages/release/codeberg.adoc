...
release:
  ...
  codeberg:
    ...
    # If left unspecified, the `JRELEASER_CODEBERG_USERNAME`
    ...
    # If left unspecified, the `JRELEASER_CODEBERG_TOKEN`
    # environment variable must be defined.
    # icon:exclamation-triangle[] icon:eye-slash[]
    ...
    # icon:exclamation-triangle[]
    apiEndpoint: pass:[https://codeberg.org]
...
[release.codeberg]
  ...
  # be set if at least one of the matchers meets the criteria.
  # icon:dot-circle[]
  pass:[[[release.codeberg.changelog.labelers]]]
    # The label to be applied.
    # icon:exclamation-triangle[]
    label = "issue"
  ...
  # Defaults are shown.
  # icon:dot-circle[]
  pass:[[[release.codeberg.changelog.categories]]]
    title = "🚀 Features"
  ...
  # Each replacer is applied in order.
  # icon:dot-circle[] icon:file-alt[]
  pass:[[[release.codeberg.changelog.replacers]]]
    search = "\[chore\]\s"
    replace = ""
  ...
  <release>
    ...
    <codeberg>
      ...
      <!--
        ...
        icon:exclamation-triangle[]
      -->
      <apiEndpoint>pass:[https://codeberg.org]</apiEndpoint>
