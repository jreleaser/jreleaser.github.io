...
release:
  ...
  gitea:
    ...
    # If left unspecified, the `JRELEASER_GITEA_USERNAME`
    ...
    # If left unspecified, the `JRELEASER_GITEA_TOKEN`
    # environment variable must be defined.
    # icon:exclamation-triangle[] icon:eye-slash[]
...
[release.gitea]
  ...
  # be set if at least one of the matchers meets the criteria.
  # icon:dot-circle[]
  pass:[[[release.gitea.changelog.labelers]]]
    # The label to be applied.
    # icon:exclamation-triangle[]
    label = "issue"
  ...
  # Defaults are shown.
  # icon:dot-circle[]
  pass:[[[release.gitea.changelog.categories]]]
    title = "🚀 Features"
  ...
  # Each replacer is applied in order.
  # icon:dot-circle[] icon:file-alt[]
  pass:[[[release.gitea.changelog.replacers]]]
    search = "\[chore\]\s"
    replace = ""
