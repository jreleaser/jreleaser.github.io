...
|===
| Key                            | Description
| JRELEASER_GITEA_${NAME}_HOST  | host of the named Gitea instance
| JRELEASER_GITEA_${NAME}_TOKEN | token of the named Gitea instance
| JRELEASER_GITEA_HOST          | host of a shared (upload, release) Gitea instance
| JRELEASER_GITEA_TOKEN         | token of a shared (upload, release) Gitea instance
|===
