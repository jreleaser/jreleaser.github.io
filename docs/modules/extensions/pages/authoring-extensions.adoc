...
xref:configuration:extensions.adoc[extensions] block found in the configuration DSL. Specific extension points
...
place them inside the default location or a custom location of their own. Review the xref:configuration:extensions.adoc[extensions]
