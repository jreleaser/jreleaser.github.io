...
| reproducible          | boolean     | JRELEASER_REPRODUCIBLE            | false
| yolo                  | boolean     | JRELEASER_YOLO                    | false
...
|                       | Boolean     | JRELEASER_SECRETS_HINT            | false
|===
...
Options
     ...
     --deploy                   Display deploy configuration (OPTIONAL).
     ...
     --reproducible             Enable reproducible artifacts (OPTIONAL).
