...
----
$ jreleaser config -h
Usage: jreleaser config [-adfhiqVw] [-grs] [--select-current-platform]
                        [-b=<basedir>] [-c=<configFile>] [-od=<outputdir>]
                        [--select-platform=<selectPlatforms>]...
...
Usage: jreleaser checksum [-dhiqVw] [-grs] [--select-current-platform]
                          [-b=<basedir>] [-c=<configFile>] [-od=<outputdir>]
                          [--select-platform=<selectPlatforms>]...
Calculate checksums.
  -b, --basedir=<basedir>   Base directory.
...
----
$ jreleaser sign -h
Usage: jreleaser sign [-dhiqVw] [-grs] [--select-current-platform]
                      [-b=<basedir>] [-c=<configFile>] [-od=<outputdir>]
                      [--select-platform=<selectPlatforms>]...
...
----
$ jreleaser upload -h
Usage: jreleaser upload [-dhiqVwy] [-grs] [--select-current-platform]
                        [-b=<basedir>] [-c=<configFile>] [-od=<outputdir>]
...
Usage: jreleaser release [-dhiqVwy] [--auto-config] [--changelog-formatted]
                         ...
                         [--select-current-platform] [--signing-armored]
                         [--signing-enabled] [--skip-tag] [--update]
...
----
$ jreleaser prepare -h
Usage: jreleaser prepare [-dhiqVw] [-grs] [--select-current-platform]
...
----
$ jreleaser package -h
Usage: jreleaser package [-dhiqVwy] [-grs] [--select-current-platform]
                         [-b=<basedir>] [-c=<configFile>]
                         [-dn=<distributionName>] [-od=<outputdir>]
                         [-tn=<toolName>]
                         [--select-platform=<selectPlatforms>]...
...
----
$ jreleaser publish -h
Usage: jreleaser publish [-dhiqVwy] [-grs] [--select-current-platform]
                         [-b=<basedir>] [-c=<configFile>]
                         [-dn=<distributionName>] [-od=<outputdir>]
                         [-tn=<toolName>]
                         [--select-platform=<selectPlatforms>]...
...
Usage: jreleaser announce [-dhiqVwy] [-grs] [--select-current-platform]
                          [-an=<announcerName>] [-b=<basedir>]
...
Usage: jreleaser full-release [-dhiqVwy] [-grs] [--select-current-platform]
                              [-b=<basedir>] [-c=<configFile>]
                              [-od=<outputdir>]
                              [--select-platform=<selectPlatforms>]...
