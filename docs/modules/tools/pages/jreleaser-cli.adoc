...
| reproducible            | JRELEASER_REPRODUCIBLE            | false
...
Usage: jreleaser config [-fghiqVw] [-grs] [--reproducible] [-scp] [--strict] [--yolo] [-b=<directory>]
...
Options:
  ...
  -D=<key=value>                            Sets a System property. 🔁
      --deploy                              Display deploy configuration.
  ...
  -q, --quiet                               Log errors only.
      --reproducible                        Enable reproducible artifacts.
...
Usage: jreleaser template eval [-ghioqVw] [-grs] [--reproducible] [-scp] [--strict] [--yolo] [-b=<directory>]
                               [-c=<file>] [-od=<directory>] [--settings-file=<file>]
                               --target-directory=<directory> [-D=<key=value>]... [-P=<key=value>]...
                               [-rp=<platform>]... [-sp=<platform>]... (--announce | --assembly | --changelog
                               | --download) (--input-file=<file> | --input-directory=<directory>)
...
Usage: jreleaser download [-ghiqVw] [--dry-run] [-grs] [--reproducible] [--strict] [--yolo] [-b=<directory>]
                          [-c=<file>] [-od=<directory>] [--settings-file=<file>] [-D=<key=value>]...
                          [-P=<key=value>]... [[[-d=<downloader>]... [-dn=<name>]...] |
...
Usage: jreleaser assemble [-ghiqVw] [-grs] [--reproducible] [-scp] [--strict] [--yolo] [-b=<directory>]
                          [-c=<file>] [-od=<directory>] [--settings-file=<file>] [-D=<key=value>]...
                          [-P=<key=value>]... [-rp=<platform>]... [-sp=<platform>]... [[[-s=<assembler>]...
...
Usage: jreleaser changelog [-ghiqVw] [--dry-run] [-grs] [--reproducible] [--strict] [--yolo] [-b=<directory>]
                           [-c=<file>] [-od=<directory>] [--settings-file=<file>] [-D=<key=value>]...
                           [-P=<key=value>]...
...
Usage: jreleaser catalog [-ghiqVw] [-grs] [--reproducible] [-scp] [--strict] [--yolo] [-b=<directory>]
                         [-c=<file>] [-od=<directory>] [--settings-file=<file>] [-D=<key=value>]...
                         [-P=<key=value>]... [-rp=<platform>]... [-sp=<platform>]...
                         [[[--distribution=<distribution>]... [--cataloger=<cataloger>]... [-y=<deployer>]...
                         [-yn=<name>]...] | [[--exclude-distribution=<distribution>]...
                         [--exclude-cataloger=<cataloger>]... [-xy=<deployer>]... [-xyn=<name>]...]]
...
Usage: jreleaser checksum [-ghiqVw] [-grs] [--reproducible] [-scp] [--strict] [--yolo] [-b=<directory>]
                          [-c=<file>] [-od=<directory>] [--settings-file=<file>] [-D=<key=value>]...
                          [-P=<key=value>]... [-rp=<platform>]... [-sp=<platform>]...
...
Usage: jreleaser sign [-ghiqVw] [-grs] [--reproducible] [-scp] [--strict] [--yolo] [-b=<directory>]
                      [-c=<file>] [-od=<directory>] [--settings-file=<file>] [-D=<key=value>]...
                      [-P=<key=value>]... [-rp=<platform>]... [-sp=<platform>]... [[[-d=<distribution>]...] |
                      [[-xd=<distribution>]...]]
...
Usage: jreleaser deploy [-ghiqVw] [--dry-run] [-grs] [--reproducible] [--strict] [--yolo] [-b=<directory>]
                        [-c=<file>] [-od=<directory>] [--settings-file=<file>] [-D=<key=value>]...
                        [-P=<key=value>]... [[[-y=<deployer>]... [-yn=<name>]...] | [[-xy=<deployer>]...
                        [-xyn=<name>]...]]
...
Usage: jreleaser upload [-ghiqVw] [--dry-run] [-grs] [--reproducible] [-scp] [--strict] [--yolo]
                        [-b=<directory>] [-c=<file>] [-od=<directory>] [--settings-file=<file>]
                        [-D=<key=value>]... [-P=<key=value>]... [-rp=<platform>]... [-sp=<platform>]...
                        [[[-u=<uploader>]... [-un=<name>]... [-d=<distribution>]...
...
Usage: jreleaser release [-ghiqVw] [--dry-run] [-grs] [--reproducible] [-scp] [--strict] [--yolo]
                         [-b=<directory>] [-c=<file>] [-od=<directory>] [--settings-file=<file>]
                         [-D=<key=value>]... [-P=<key=value>]... [-rp=<platform>]... [-sp=<platform>]...
                         [[[-d=<distribution>]... [-y=<deployer>]... [-yn=<name>]... [-u=<uploader>]...
                         [-un=<name>]... [--cataloger=<cataloger>]...] | [[-xd=<distribution>]...
                         [-xy=<deployer>]... [-xyn=<name>]... [-xu=<uploader>]... [-xun=<name>]...
                         [--exclude-cataloger=<cataloger>]...] | [[--auto-config] [--project-name=<name>]
                         [--project-version=<version>] [--project-version-pattern=<pattern>]
                         [--project-snapshot-pattern=<pattern>] [--project-snapshot-label=<label>]
                         [--project-snapshot-full-changelog] [--project-copyright=<copyright>]
                         [--project-description=<description>] [--project-inception-year=<year>]
                         [--project-stereotype=<stereotype>] [--author=<author>]... [--tag-name=<tag>]
                         [--previous-tag-name=<tag>] [--release-name=<name>] [--milestone-name=<name>]
                         [--prerelease] [--prerelease-pattern=<pattern>] [--draft] [--overwrite] [--update]
...
Usage: jreleaser prepare [-ghiqVw] [-grs] [--reproducible] [-scp] [--strict] [--yolo] [-b=<directory>]
                         [-c=<file>] [-od=<directory>] [--settings-file=<file>] [-D=<key=value>]...
                         [-P=<key=value>]... [-rp=<platform>]... [-sp=<platform>]... [[[-d=<distribution>]...
                         [-p=<packager>]...] | [[-xd=<distribution>]... [-xp=<packager>]...]]
...
Usage: jreleaser package [-ghiqVw] [--dry-run] [-grs] [--reproducible] [-scp] [--strict] [--yolo]
                         [-b=<directory>] [-c=<file>] [-od=<directory>] [--settings-file=<file>]
                         [-D=<key=value>]... [-P=<key=value>]... [-rp=<platform>]... [-sp=<platform>]...
...
Usage: jreleaser publish [-ghiqVw] [--dry-run] [-grs] [--reproducible] [-scp] [--strict] [--yolo]
                         [-b=<directory>] [-c=<file>] [-od=<directory>] [--settings-file=<file>]
                         [-D=<key=value>]... [-P=<key=value>]... [-rp=<platform>]... [-sp=<platform>]...
                         [[[-d=<distribution>]... [-p=<packager>]...] | [[-xd=<distribution>]...
                         [-xp=<packager>]...]]
...
Usage: jreleaser announce [-ghiqVw] [--dry-run] [-grs] [--reproducible] [--strict] [--yolo] [-b=<directory>]
                          [-c=<file>] [-od=<directory>] [--settings-file=<file>] [-D=<key=value>]...
                          [-P=<key=value>]... [[[-a=<announcer>]...] | [[-xa=<announcer>]...]]
...
Usage: jreleaser full-release [-ghiqVw] [--dry-run] [-grs] [--reproducible] [-scp] [--strict] [--yolo]
                              [-b=<directory>] [-c=<file>] [-od=<directory>] [--settings-file=<file>]
                              [-D=<key=value>]... [-P=<key=value>]... [-rp=<platform>]... [-sp=<platform>]...
