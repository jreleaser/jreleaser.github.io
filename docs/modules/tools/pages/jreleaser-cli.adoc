...
Usage: jreleaser template eval [-ghioqVw] [-grs] [-scp] [--strict] [--yolo] [-b=<directory>] [-c=<file>]
                               ...
                               [-P=<key=value>]... [-rp=<platform>]... [-sp=<platform>]... (--announce |
                               --assembly | --changelog | --download) (--input-file=<file> |
...
Usage: jreleaser assemble [-ghiqVw] [-grs] [-scp] [--strict] [--yolo] [-b=<directory>] [-c=<file>]
                          [-od=<directory>] [-D=<key=value>]... [-P=<key=value>]... [-rp=<platform>]...
                          [-sp=<platform>]... [[[-s=<assembler>]... [-d=<distribution>]...] |
...
Usage: jreleaser catalog [-ghiqVw] [-grs] [-scp] [--strict] [--yolo] [-b=<directory>] [-c=<file>]
                         [-od=<directory>] [-D=<key=value>]... [-P=<key=value>]... [-rp=<platform>]...
                         [-sp=<platform>]... [[[--distribution=<distribution>]...
...
Usage: jreleaser checksum [-ghiqVw] [-grs] [-scp] [--strict] [--yolo] [-b=<directory>] [-c=<file>]
                          [-od=<directory>] [-D=<key=value>]... [-P=<key=value>]... [-rp=<platform>]...
                          [-sp=<platform>]... [[[-d=<distribution>]...] | [[-xd=<distribution>]...]]
...
Usage: jreleaser full-release [-ghiqVw] [--dry-run] [-grs] [-scp] [--strict] [--yolo] [-b=<directory>]
                              [-c=<file>] [-od=<directory>] [-D=<key=value>]... [-P=<key=value>]...
                              [-rp=<platform>]... [-sp=<platform>]... [[[-y=<deployer>]... [-yn=<name>]...
                              [-u=<uploader>]... [-un=<name>]... [-d=<distribution>]... [-p=<packager>]...
                              [-a=<announcer>]... [--cataloger=<cataloger>]...] | [[-xy=<deployer>]...
                              [-xyn=<name>]... [-xu=<uploader>]... [-xun=<name>]... [-xd=<distribution>]...
