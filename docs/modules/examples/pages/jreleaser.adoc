  ...
  jlink:
    jreleaser-standalone:
      ...
      targetJdks:
        ...
        - path: '{{jdkPathPrefix}}/zulu17Linux32/{{jdkFilePrefix}}-linux_i686'
        ...
        - path: '{{jdkPathPrefix}}/zulu17Windows32/{{jdkFilePrefix}}-win_i686'
...
jreleaser-standalone-{jreleaser-effective-version}-linux-x86_32.zip
...
jreleaser-standalone-{jreleaser-effective-version}-windows-x86_32.zip
...
jreleaser-standalone-{jreleaser-effective-version}-linux-x86_32.zip.asc
...
jreleaser-native-{jreleaser-effective-version}-windows-x86_32.zip.asc
